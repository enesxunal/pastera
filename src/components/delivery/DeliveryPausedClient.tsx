...
export function DeliveryPausedClient() {
  ...
  return (
    <div className="mx-auto flex min-h-[60vh] max-w-lg flex-col items-center justify-center px-4 py-16 text-center">
      ...
      >
        {t("delivery.pausedCta")}
      </Link>
      <Link href="/menu" className="mt-4 text-sm text-white/45 hover:text-[#c49746]">
        {t("nav.menu")}
      </Link>
    </div>
  );
